...
from orm.common import User, Config, Resource, ResourceGain  # noqa
...
from orm.queued import BuildingQueue  # noqa
...
config.set_main_option('sqlalchemy.url', os.getenv('BELIEF_ORM_URL'))
